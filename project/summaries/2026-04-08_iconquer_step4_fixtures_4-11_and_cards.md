...
- **Decision:** Approve and execute the *Cards & PendingInput* design proposal end-to-end in this session. Proposal lives at `project/plans/upcoming/2026-04-07_IconquerCore_cards_and_pending_input.md`.
