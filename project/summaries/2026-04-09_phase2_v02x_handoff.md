...
- Summary written: `project/summaries/2026-04-08_phase2_v0_2_0_ship.md`
- Checklist archived to `04_99_COMPLETED/`

### ADR-001 committed (IconquerCLI repo)

- `development-guidelines/rules/architecture_decisions.md`
...
1. `IconquerCLI/development-guidelines/rules/architecture_decisions.md` — ADR-001 (the plan)
