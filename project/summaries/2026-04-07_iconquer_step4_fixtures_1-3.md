...
- ✅ Active checklist updated through Step 4 sub-bullets 1 and 2: `project/checklists/CURRENT_iconquer_core_phase1.md` (the 3rd `RED/GREEN` row — country picking — and the 4th — initial army placement — are now ticked, but with annotation that fixture 03 only exercises the rotation, not the full transition to `.play` end-to-end).
