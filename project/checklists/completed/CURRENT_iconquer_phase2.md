...
**Design proposals:**
- `project/plans/upcoming/2026-04-08_iconquer_phase2_AI_CLI_SwiftUI.md` (master, Revision 4)
- `project/plans/upcoming/MultiAgentPlayerBinding.md` (the IconquerMatch design — APPROVED 2026-04-08)
...
- [x] `project/master_plan.md` customised for IconquerAI
...
- [x] Write summary in `iconquer/development-guidelines/project/summaries/`
